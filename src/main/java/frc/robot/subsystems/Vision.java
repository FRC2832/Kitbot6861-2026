...
public class Vision extends SubsystemBase {
  ...
  public Vision() {
    ...
    leftPoseEstimator = new PhotonPoseEstimator(CameraConstants.tagLayout, CameraConstants.leftCamPose);
    rightCam = new PhotonCamera(CameraConstants.rightCamName);
    rightPoseEstimator = new PhotonPoseEstimator(CameraConstants.tagLayout, CameraConstants.rightCamPose);
    leftResults = new LinkedList<>();
    rightResults = new LinkedList<>();
    if(Robot.isSimulation()){
      visionSim = new VisionSystemSim("Vision");
      visionSim.addAprilTags(CameraConstants.tagLayout);
      ...
      visionSim.addCamera(leftCamSim, CameraConstants.leftCamPose);
      visionSim.addCamera(rightCamSim, CameraConstants.rightCamPose);
    }
  }
